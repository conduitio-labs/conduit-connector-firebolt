...
func (m *MockIterator) Ack(ctx context.Context, p sdk.Position) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Ack", ctx, p)
	ret0, _ := ret[0].(error)
	return ret0
}

// Ack indicates an expected call of Ack.
func (mr *MockIteratorMockRecorder) Ack(ctx, p any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Ack", reflect.TypeOf((*MockIterator)(nil).Ack), ctx, p)
}
...
func (mr *MockIteratorMockRecorder) Setup(ctx, p any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
